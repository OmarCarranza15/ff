      ...
      try {
        ...
        const puestoExists = response.data.some(
          (puesto) =>
            ...
            puesto.Codigo.toString().toLowerCase() === modalValues.Codigo.toLowerCase()
        );
  
        if (puestoExists) {
          setErrors({ ...newErrors, N_Puesto: "El Nombre del Puesto ya existe" }) ||
          setErrors({...newErrors, Codigo: "El Codigo del Puesto ya existe"})
          return;
        } 
