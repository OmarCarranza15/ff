...
function RazonSocial() {
  ...
  const SaveModal = () => {
    ...
    if (Object.values(newErrors).every((error) => error === "")) {
      // Ingresar una nueva razón social
      console.log("Nueva Razón Social:", modalValues.rsocial);
      const updatedRecords = [
        ...records,
        {
          id: records.length + 1,
          pais: modalValues.pais,
          rsocial: modalValues.rsocial,
        },
      ];
      ...
      {showModal && (
        <ModalBackground>
          <ModalWrapper>
            ...
            //aqui se debe generar los paises para hacer la insercion 
