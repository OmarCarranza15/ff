  ...
  useEffect(()=> {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const filteredData = data.filter(perfil => perfil.ID_Pais === parseInt(paisId, 10));
      ...
      <ContentContainer>
        ...
        <DataTableContainer>
          <HeaderContainer>
            ...
            <ButtonGroup>
              <Button primary onClick={toggleFilters}>{showFilters ? "Ocultar" : "Buscar"}</Button>
              {permissions.insert &&<Button onClick={handleInsert}><FaPlus />Insertar Nuevo Perfil</Button>}
            </ButtonGroup>
          </HeaderContainer>
