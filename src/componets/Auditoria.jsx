...
function Auditoria() {
  ...
  const formatDateForFilter = (date) => {
    return moment(date).format('YYYY-MM-DD h:mm A'); // Asegúrate de que el formato coincida con el de tus datos
  };
  ...
  const filteredData = records.filter((row) => {
    ...
    return (
      ...
      (filters.createdAt === "" || formattedDate.includes(filters.createdAt)) && // Usa el formato adecuado para el filtro
