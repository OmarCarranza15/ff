    ...
    if (Object.values(newErrors).every((error) => error === "")) {
      try {
        ...
        const nombreExistente = centrocostos.some(
          (centrocosto) => centrocosto.Nombre.toLowerCase() === modalValues.Nombre.toLowerCase()
        )

        const codigoExistente = centrocostos.some(
          (centrocosto) => centrocosto.Codigo.toLowerCase() === modalValues.Codigo.toLowerCase()
        )
  ...
  return (
    <MainContainer>
      ...
      <ContentContainer>
        ...
        <DataTableContainer>
          <HeaderContainer>
            <Title><h2 className="Title">Centro de Costes</h2></Title>
            <ButtonGroup>
              <Button primary onClick={toggleFilters}>
                {showFilters ? "Ocultar" : "Buscar"}
              </Button>
              <Button onClick={handleInsert}>Nuevo Centro de Costes</Button>
            </ButtonGroup>
          </HeaderContainer>
        ...
        <ModalBackground>
          <ModalWrapper>
            ...
            <ModalInput
              ...
              placeholder="Nombre Centro de Coste"
              error={errors.Nombre}
              required
            />
            {errors.Nombre && (
